...
<head>
  ...
  <title>Appointment Confirmation OTP – CareConnect</title>
</head>
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="background:#e8f5e9;padding:20px 40px;text-align:center;border-bottom:1px solid #c8e6c9;">
              <p style="margin:0;font-size:20px;font-weight:700;color:#2e7d32;">🗓️ Appointment Start Confirmation</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:36px 40px 32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#555555;line-height:1.6;">
                Use the OTP below to confirm the start of your appointment. This code expires in <strong>15 minutes</strong>.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding:20px 0;">
                    <div style="display:inline-block;background:#f1f8e9;border:2px dashed #43a047;border-radius:10px;padding:20px 48px;">
                      <p style="margin:0;font-size:38px;font-weight:800;letter-spacing:10px;color:#2e7d32;font-family:'Courier New',monospace;">${otp}</p>
                    </div>
                  </td>
                </tr>
              </table>
              ...
              <p style="margin:24px 0 0;font-size:13px;color:#888888;line-height:1.6;">
                If you did not initiate this appointment, please contact your healthcare provider immediately.
              </p>
            </td>
          </tr>

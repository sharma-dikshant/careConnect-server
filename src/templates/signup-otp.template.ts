export function signupOtpTemplate(name: string, otp: string): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#555555;line-height:1.6;">
                Welcome to CareConnect! Please use the OTP below to verify your email address and complete your registration.
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding:20px 0;">
                    <div style="display:inline-block;background:#f0f4ff;border:2px dashed #1a73e8;border-radius:10px;padding:20px 48px;">
                      <p style="margin:0;font-size:38px;font-weight:800;letter-spacing:10px;color:#1a73e8;font-family:'Courier New',monospace;">${otp}</p>
                    </div>
                  </td>
                </tr>
              </table>
